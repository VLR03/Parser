...
class Lexer:
    ...
    def make_tokens(self):
        ...
        tokens.append(Token(TT_EOF, pos_start=self.pos))  # verifica se chegamos ao final do arquivo
        return tokens, None
...
class Number:  # Armazena os números e fazer operações com eles
    ...
    def get_comparison_eq(self, other):
        if isinstance(other, Number):  # Checa se o valor é um número
            return Number(int(self.value == other.value)).set_context(self.context), None  # Verifica a operação
    ...
    def anded_by(self, other):
        if isinstance(other, Number):  # Checa se o valor é um número
            return Number(int(self.value and other.value)).set_context(self.context), None  # Verifica a operação

    def ored_by(self, other):
        if isinstance(other, Number):  # Checa se o valor é um número
            return Number(int(self.value or other.value)).set_context(self.context), None  # Verifica a operação
